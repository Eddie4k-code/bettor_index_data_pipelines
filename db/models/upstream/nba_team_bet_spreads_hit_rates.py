"""Read-only mirror of hit_rate_worker ``nba_team_bet_spreads_hit_rates``."""
...
class NbaTeamBetSpreadsHitRates(UpstreamBase):
    __tablename__ = "nba_team_bet_spreads_hit_rates"
