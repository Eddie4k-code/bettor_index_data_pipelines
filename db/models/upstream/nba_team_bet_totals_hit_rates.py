"""Read-only mirror of hit_rate_worker ``nba_team_bet_totals_hit_rates``."""
...
class NbaTeamBetTotalsHitRates(UpstreamBase):
    __tablename__ = "nba_team_bet_totals_hit_rates"
