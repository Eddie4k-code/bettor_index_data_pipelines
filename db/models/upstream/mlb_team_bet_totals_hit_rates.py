"""Read-only mirror of hit_rate_worker ``mlb_team_bet_totals_hit_rates``."""
...
class MlbTeamBetTotalsHitRates(UpstreamBase):
    __tablename__ = "mlb_team_bet_totals_hit_rates"
