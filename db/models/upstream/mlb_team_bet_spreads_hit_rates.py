"""Read-only mirror of hit_rate_worker ``mlb_team_bet_spreads_hit_rates``."""
...
class MlbTeamBetSpreadsHitRates(UpstreamBase):
    __tablename__ = "mlb_team_bet_spreads_hit_rates"
