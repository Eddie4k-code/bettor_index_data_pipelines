"""Mlb H2H pregame snapshot orchestrator."""
...
from interfaces.mlb_h2h_hit_rate_read_repository_interface import MlbH2hHitRateReadRepositoryInterface
from interfaces.mlb_h2h_snapshot_pipeline_interface import MlbH2hSnapshotPipelineInterface
from interfaces.mlb_h2h_snapshot_repository_interface import MlbH2hSnapshotRepositoryInterface
...
class MlbH2hSnapshotPipeline(MlbH2hSnapshotPipelineInterface):
    def __init__(
        self,
        *,
        odds_repo: FeaturedOddsReadRepositoryInterface,
        hit_rate_repo: MlbH2hHitRateReadRepositoryInterface,
        snapshot_repo: MlbH2hSnapshotRepositoryInterface,
    ...
    def run(self, request: SnapshotRequest) -> SnapshotRunResult:
        ...
        logger.info(
            "MLB H2H snapshot run complete observation_time=%s candidates=%s snapshotted=%s "
