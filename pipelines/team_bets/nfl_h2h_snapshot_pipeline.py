"""Nfl H2H pregame snapshot orchestrator."""
...
from interfaces.nfl_h2h_snapshot_pipeline_interface import NflH2hSnapshotPipelineInterface
...
class NflH2hSnapshotPipeline(NflH2hSnapshotPipelineInterface):
    def __init__(
        self,
        *,
        odds_repo: FeaturedOddsReadRepositoryInterface,
        hit_rate_repo: NflH2hHitRateReadRepositoryInterface,
        snapshot_repo: NflH2hSnapshotRepositoryInterface,
    ...
    def run(self, request: SnapshotRequest) -> SnapshotRunResult:
        ...
        logger.info(
            "NFL H2H snapshot run complete observation_time=%s candidates=%s snapshotted=%s "
